...
function runGame(gameType) {
    //Creates two random number betwen 1 and 25
...
function calculateCorrectAnswer() {
    ...
    if (operator === "+") {
        ...
        throw `Unimplemented operatore ${operator}. Aborting!`; 
    }
}
...
/**
 * Gets the current tally of incorrect answer from the DOM and ioncrement it by 1
 */
